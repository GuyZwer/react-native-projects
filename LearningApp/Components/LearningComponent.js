...
export class Greeting extends Component {
  render() {
    return (
      <Text>Hello {this.props.dom}{this.props.name}!</Text>
    );
  }
}
  ...
  render() {
    return (
      <View>
        ...
        <Text style={[styles.bigblue]}>bigblue</Text><Text style={[styles.red]}>, then red</Text>
        <Text style={[styles.red]}>red,</Text><Text style={[styles.bigblue]}>then bigblue</Text>
      </View>
    );
  }
}
